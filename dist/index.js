  ...
  process({
    ...
    return _asyncToGenerator(function* () {
      ...
      if (plugins.length === 0) {
        ...
        const noopPlugin = postcss__default['default'].plugin('postcss-noop-plugin', () => () => {
          /* noop */
        });
      ...
      return _asyncToGenerator(function* () {
        ...
        const getExtracted = () => {
          ...
          if (typeof postcssLoaderOptions.extract === 'string') {
            if (path__default['default'].isAbsolute(postcssLoaderOptions.extract)) {
              fileName = normalizePath(path__default['default'].relative(dir, postcssLoaderOptions.extract));
            } else {
